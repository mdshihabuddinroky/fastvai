...
class AppColors {
  ...
  static const secondary = Color(0xff302F3C);
  static const lightGray = Color(0xffc0c1c3);
  static const lighterGray = Color(0xECEBE0E0);
  static const black = Colors.black;
  static const darkGrey = Colors.black38;
  static const primary = Color(0xffF95E1B);
  static const secondatestry = Color(0xffff36b6b);
  static const third = Color(0xff817b2b);
}
